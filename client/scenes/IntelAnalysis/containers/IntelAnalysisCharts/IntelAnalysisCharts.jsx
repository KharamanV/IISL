        ...
        <div styleName="chart-single">
          <div>
            ...
            <AreaChart width={800} height={400} data={[
              ...
              {name: 'Февраль', uv: 0, pv: 3800, amt: 2500},
              {name: 'Март', uv: 0, pv: 4300, amt: 2100},
              {name: 'Апрель', uv: 0, pv: 4300, amt: 2100},
              {name: 'Май', uv: 0, pv: 4300, amt: 2100},
              {name: 'Июнь', uv: 0, pv: 4300, amt: 2100},
            ]}
        ...
        <div styleName="chart-single">
          <div>
            ...
            <AreaChart width={800} height={400} data={[
              ...
              {name: 'Декабрь', uv: 2780, pv: 3908, amt: 2000},
              {name: 'Январь', uv: -1890, pv: 4800, amt: 2181},
              {name: 'Февраль', uv: 0, pv: 0, amt: 2500},
              {name: 'Март', uv: 0, pv: 0, amt: 2100},
              {name: 'Апрель', uv: 0, pv: 0, amt: 2100},
              {name: 'Май', uv: 0, pv: 0, amt: 2100},
              {name: 'Июнь', uv: 0, pv: 0, amt: 2100},
            ]}
                       margin={{top: 10, right: 30, left: 0, bottom: 0}}>
              <XAxis dataKey="name"/>
              <YAxis/>
...
export default CSSModules(IntelAnalysis, styles);
